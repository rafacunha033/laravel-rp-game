...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-sm mt-3" style="max-width:23rem;">
            <div class="card">
                <div class="card-header"><a class="text-info" href="{{ route('index.game') }}">Entrar em uma Partida</a></div>
        ...
        <div class="col-sm mt-3" style="max-width:23rem;">
            <div class="card">
                <div class="card-header"><a href="{{ route('index.round') }}">Meus jogos</a></div>
